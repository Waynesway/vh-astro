export default {
  ...
  Title: '无聊的博客',
  // 网站地址
  Site: 'https://blog.15062715.xyz',
  // 网站副标题
  Subtitle: '无聊以至于折腾各种没用的垃圾.',
  // 网站描述
  Description: '只是不知道该记录下什么东西总是在做博客的路上。希望这次的坚持时间能够长一点了。',
  // 网站作者
  Author: 'Wayne',
  // 作者头像
  Avatar: 'https://raw.githubusercontent.com/diegosway2023/picgopics/master/image_171.png',
  // 网站座右铭
  Motto: '机会是给有准备的人准备的.',
  // Cover 网站缩略图
